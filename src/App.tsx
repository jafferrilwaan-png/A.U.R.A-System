...
export default function App() {
  ...
  return (
    <div className="bg-[#080B10] text-white selection:bg-[#C084FC] selection:text-black overflow-x-hidden min-h-screen relative font-sans tracking-normal leading-relaxed">
      ...
      {/* --- SCROLLYTELLING CANVAS (ACTIVE ALL THE WAY THROUGH TEAM MEMBERS) --- */}
      {!loading && (
        <canvas 
          ref={canvasRef} 
          ...
          style={{ 
            ...
            zIndex: 0,
            opacity: scrollFraction > 0.94 ? 0 : 1 // Canvas stays visible through Members section
          }}
        />
      )}

      {/* --- GALAXY VIDEO BACKGROUND (FADES IN ONLY AFTER MEMBERS SECTION IS COMPLETE) --- */}
      {!loading && (
        <video
          ...
          style={{ 
            zIndex: 0,
            opacity: scrollFraction > 0.94 ? 0.75 : 0 // Fades in ONLY at the absolute end footer
          }}
        />
      )}
          ...
          >
            ...
            <div className="flex flex-col gap-6 items-center text-center">
              <motion.div
                ...
                className="text-3xl tracking-[0.4em] font-light text-white/60 uppercase font-display"
              >
              ...
              <motion.div
                ...
                className="text-8xl font-black tracking-tight text-flowing-purple font-display"
              >
                AURA
              </motion.div>
              ...
              <motion.div
                ...
                className="text-4xl italic tracking-wider text-white/60 animate-pulse font-display"
              >
                A   U   R   A
              </motion.div>
              ...
              <motion.div
                ...
                className="text-xl font-bold tracking-[0.4em] text-flowing-purple border border-[#9333EA]/30 px-6 py-2 rounded-lg font-display"
              >
                SYSTEM ONLINE
              </motion.div>
            </div>

            <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-48 h-[1.5px] bg-white/10 overflow-hidden">
              <motion.div
                initial={{ left: "-100%" }}
                animate={{ left: "100%" }}
      ...
      {/* --- FIXED FLOATING CAPSULE NAVBAR --- */}
      <motion.nav
        initial={{ opacity: 0, y: -20 }}
        animate={entranceComplete ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.8 }}
        className="fixed top-5 left-6 right-6 z-50 h-14 max-w-7xl mx-auto px-4 flex items-center justify-between backdrop-blur-xl bg-black/40 border border-white/10 rounded-full"
      >
        <div className="flex items-center gap-3">
          ...
          >
            <AuraLogo className="w-8 h-8 object-cover rounded-full border border-[#C084FC]/40 shadow-[0_0_10px_rgba(147,51,234,0.3)]" />
          </motion.div>

          <div className="hidden md:flex items-center gap-6 px-5 py-1 border-l border-white/10 text-[11px] uppercase font-semibold tracking-widest text-white/70 font-display">
        ...
        <div className="flex items-center gap-4">
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            whileHover={{ scale: 1.04, backgroundColor: "#C084FC", color: "#000" }}
            whileTap={{ scale: 0.96 }}
            className="h-9 px-4 bg-white/10 backdrop-blur-md rounded-full flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wider border border-white/15 text-white transition-all font-display"
          >
      ...
      <div className="relative z-10 w-full bg-transparent">
        ...
        <section ref={heroRef} className="h-screen w-full flex flex-col justify-center px-6 sm:px-12 pt-20 bg-transparent">
          ...
          <motion.div 
            style={heroScroll}
            className="max-w-4xl flex flex-col gap-6 text-left"
          >
            ...
            <p className="max-w-xl text-base sm:text-lg text-white/80 leading-relaxed font-normal tracking-normal">
        ...
        <section ref={problemRef} className="min-h-screen w-full flex flex-col justify-center px-6 sm:px-12 py-24 bg-transparent">
          <motion.div style={problemScroll} className="max-w-5xl mx-auto w-full">
            <div className="mb-16 border-b border-white/10 pb-6">
              <span className="text-[#C084FC] text-xs font-bold tracking-widest uppercase block mb-2 font-display">CRITICAL VECTOR</span>
        ...
        <section ref={missionRef} className="min-h-screen w-full flex flex-col justify-center px-6 sm:px-12 py-24 bg-transparent">
          <motion.div style={missionScroll} className="max-w-5xl mx-auto w-full">
            <div className="mb-16 border-b border-white/10 pb-6">
              <span className="text-[#C084FC] text-xs font-bold tracking-widest uppercase block mb-2 font-display">THE HUMAN COST & OUR MISSION</span>
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center text-left">
              <div className="border-l-2 border-[#9333EA] pl-6 py-2">
                <span className="text-5xl font-bold text-flowing-purple block mb-2 font-display">80,000+</span>
                <p className="text-xs text-white/60 uppercase tracking-widest font-semibold font-display">Lives Lost Annually</p>
                <p className="text-sm text-white/80 mt-2 font-normal">Lost under building collapses globally, where lack of real-time cavity search mappings delays responders.</p>
              </div>

              <div className="border-l-2 border-[#9333EA] pl-6 py-2">
                <span className="text-5xl font-bold text-flowing-purple block mb-2 font-display">80%</span>
                <p className="text-xs text-white/60 uppercase tracking-widest font-semibold font-display">Preventable Deaths</p>
                <p className="text-sm text-white/80 mt-2 font-normal">Of deaths post-collapse are due to suffocation or dynamic shifting, occurring because victims cannot be located within the crucial 72-hour window.</p>
              </div>

              <div className="md:col-span-1 border-t md:border-t-0 md:border-l border-white/10 md:pl-8 pt-6 md:pt-0">
        ...
        <section ref={techRef} className="min-h-screen w-full flex flex-col justify-center px-6 sm:px-12 py-24 bg-transparent">
          <motion.div style={techScroll} className="max-w-7xl mx-auto w-full">
            <div className="text-center mb-20 border-b border-white/10 pb-8">
              <span className="text-[#C084FC] text-xs font-bold tracking-widest uppercase block mb-2 font-display">SYSTEM FLOW</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-0 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
              {[
                ...
                <div key={idx} className="p-8 flex flex-col justify-between min-h-[200px] text-left">
                  <div>
                    <span className="text-[#C084FC] text-xs font-bold block mb-4 font-display">MODULE_0{idx + 1}</span>
        ...
        <section ref={telemetryRef} className="min-h-screen w-full flex flex-col justify-center px-6 sm:px-12 py-24 bg-transparent">
          <motion.div style={telemetryScroll} className="max-w-7xl mx-auto w-full">
            <div className="text-center mb-16 border-b border-white/10 pb-6">
              <span className="text-[#C084FC] text-xs font-bold tracking-widest uppercase block mb-2 font-display">VISUAL DATA</span>
            ...
            <div className="grid lg:grid-cols-3 gap-12 items-start">
              {/* Left Column: Browser Mockup with CRISP WHITE CODE */}
              <div className="lg:col-span-2 rounded-xl overflow-hidden border border-white/10 bg-[#05070A]/95 shadow-2xl">
                <div className="h-10 bg-white/5 border-b border-white/10 px-4 flex items-center justify-between">
                  ...
                  <span className="text-xs text-white/40 font-mono select-none">telemetry_feed.py</span>
                  <div className="w-12" />
                </div>
                <pre className="p-6 md:p-8 overflow-x-auto text-[12px] md:text-sm text-white/90 font-mono leading-relaxed select-text">
{`import time
import numpy as np
...
while True:
    ...
    time.sleep(1.0)`}
              ...
              <div className="flex flex-col gap-8">
                <div className="overflow-hidden border-b border-white/10 pb-4 group">
                  <img 
                    src="high_res_frames/frame-100.jpg" 
                    alt="Subsurface model scan phase 1" 
                    className="w-full h-[200px] object-cover rounded-lg group-hover:scale-[1.02] transition-all duration-300"
                    onError={(e) => {
                      e.currentTarget.src = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800";
                    }}
                  />
                  <div className="pt-4 text-left">
                    <span className="text-[#C084FC] text-xs font-bold block mb-1 font-display">MODEL PROFILE 01</span>
                    <h4 className="text-lg font-bold text-flowing-purple mb-1 font-display">Tunnel Cavity Scan</h4>
                    <p className="text-xs text-white/60 leading-relaxed font-normal">Maps structural cavities and returns safety margins.</p>
                  </div>
                </div>
                ...
                <div className="overflow-hidden border-b border-white/10 pb-4 group">
                  ...
                  />
                  <div className="pt-4 text-left">
                    <span className="text-[#C084FC] text-xs font-bold block mb-1 font-display">MODEL PROFILE 02</span>
                    <h4 className="text-lg font-bold text-flowing-purple mb-1 font-display">Void Isolation Map</h4>
                    <p className="text-xs text-white/60 leading-relaxed font-normal">Highlights internal structures to locate survivors.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* --- SECTION 5: TEAM GRID (CANVAS REMAINS ACTIVE ALL THROUGH MEMBERS) --- */}
        <section ref={teamRef} className="min-h-screen w-full flex flex-col justify-center px-6 sm:px-12 py-24 bg-transparent border-t border-white/10">
          <motion.div style={teamScroll} className="max-w-7xl mx-auto w-full">
            <div className="text-center mb-20">
              <span className="text-[#C084FC] text-xs font-bold tracking-widest uppercase mb-3 block font-display">COLLABORATIVE ARCHITECTURE</span>
              ...
              <p className="text-white/60 text-sm mt-3 max-w-md mx-auto leading-relaxed font-normal">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8">
              {[
                ...
                >
                  <div className="w-full h-[240px] rounded-lg overflow-hidden border border-white/10 group-hover:border-[#C084FC] transition-all mb-4 relative shadow-lg">
                    <img 
                      src={member.img} 
                      alt={member.name} 
                  ...
                  <div className="text-xs text-white/50 tracking-wider uppercase font-light">{member.role}</div>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        {/* --- FOOTER (GALAXY BACKDROP FADES IN STRICTLY AFTER MEMBERS ARE COMPLETELY PASSED) --- */}
        <footer className="relative bg-transparent border-t border-white/10 flex flex-col items-center justify-between min-h-[450px] py-16 px-6 sm:px-12">
          <div className="flex flex-col items-center justify-center text-center my-12">
            ...
            >
              <AuraLogo className="w-24 h-24 object-cover rounded-full border-2 border-[#C084FC]/40 group-hover:border-[#C084FC] transition-colors shadow-[0_0_30px_rgba(147,51,234,0.4)]" />
              
              <span className="text-7xl font-bold tracking-tighter text-flowing-purple font-display">
                AURA
              </span>
            </motion.div>
            <p className="text-white/70 text-sm leading-relaxed max-w-md mt-6 font-normal">
              Bridging the gap between first responders and life trapped beneath disaster rubble. Zero unmapped survivors.
            </p>
          </div>
          
          <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center border-t border-white/5 pt-8">
            <div className="text-[11px] text-white/40 tracking-widest font-semibold">
