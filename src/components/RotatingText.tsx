...
const splitIntoCharacters = (text: string): string[] => {
  if (typeof Intl !== "undefined" && "Segmenter" in Intl) {
    ...
    return Array.from(segmenter.segment(text), (part) => (part as any).segment);
  }
...
export default function RotatingText({
  prefix = "",
  texts = ["SUBTERRANEAN SENSORY CORE", "SEISMIC CAVITY MAPPING", "ACOUSTIC LIFE DETECTION", "REAL-TIME EDGE TELEMETRY"],
  font = {
  ...
  color = "#C084FC",
  prefixColor = "#E8E8E8",
  badgeBackground = "rgba(192, 132, 252, 0.12)",
  badgePaddingX = 14,
  badgePaddingY = 6,
  badgeRadius = 9999,
  gap = 8,
  ...
  const safeTexts =
    texts && texts.length > 0
      ? texts
      : ["A.U.R.A. CORE", "LIFE DETECTION", "SEISMIC MAP"];
